package com.yyyxl.lottery.domain.activity.service.partake.impl;
...
import com.yyyxl.lottery.domain.activity.repository.IUserTakeActivityRepository;
import com.yyyxl.lottery.domain.activity.service.partake.BaseActivityPartake;
...
public class ActivityPartakeImpl extends BaseActivityPartake {
    ...
    @Override
    protected Result chenkActivityBill(PartakeReq partake, ActivityBillVO bill) {
        ...
        logger.warn(" partake.getPartakeDate()：{}", partake.getPartakeDate());
        // 校验：活动日期
    ...
    @Override
    protected Result grabActivityz(PartakeReq partake, ActivityBillVO bill) {
        ...
        try {
            ...
            return transactionTemplate.execute(status -> {
                try {
                    ...
                    // 插入领取活动信息
                    Long takeId = idContext.iIdGenerator(Constants.Ids.SnowFlake).nextId();
