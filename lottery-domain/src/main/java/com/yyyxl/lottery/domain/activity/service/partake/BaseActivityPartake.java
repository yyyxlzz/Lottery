...
public abstract class BaseActivityPartake extends ActivityPartakeSupport implements IActivityPartake {
    ...
    public PartakeResult doPartake(PartakeReq req) {
        ...
        Result checkResult  = this.chenkActivityBill(req, activityBillVO);
        ...
        Result grabResult  = this.grabActivityz(req, activityBillVO);
     ...
     * @return 校验结果
     */
    protected abstract Result chenkActivityBill(PartakeReq partake, ActivityBillVO bill);
     ...
     * @return 领取结果
     */
    protected abstract Result grabActivityz(PartakeReq partake, ActivityBillVO bill);
