package com.yyyxl.lottery.test.dao;
...
public class UserStrategyExportDaoTest {
    ...
    public void test_insert() {
        ...
        userStrategyExport.setActivityId(idContext.iIdGenerator(Constants.Ids.ShortCode).nextId());
        userStrategyExport.setOrderId(idContext.iIdGenerator(Constants.Ids.SnowFlake).nextId());
        userStrategyExport.setStrategyId(idContext.iIdGenerator(Constants.Ids.RandomNumeric).nextId());
...
//        List<UserStrategyExport> userStrategyExport
